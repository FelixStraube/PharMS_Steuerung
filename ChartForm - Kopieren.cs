...
{
    public partial class ChartFormKopie : Form
    {
         
        public DataSet TEMP; 
        public Form1 _Form1;
        public ChartFormKopie(Form1 MainForm,int MZ_ID)
        {
            InitializeComponent();
            _Form1 = MainForm;
  ...
  //          if (MZ_ID < trackBar1.Maximum) { trackBar1.Value = MZ_ID ; };
           string Temp_MZ_ID = MainForm.MesszyklusGrid.Rows[MZ_ID].Cells["ID"].Value.ToString();
            ...
            DataView dvMesswerte = new DataView(TEMP.Tables["Messwerte"]);
            dvMesswerte.RowFilter = "MW1 <> -9999.9 AND MW2 <> -9999.9";
